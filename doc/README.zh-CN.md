...
- **模块化设置**：shell config 通过 [docker_setup_helper](https://github.com/ycpss91255/docker_setup_helper) subtree 管理
...
位于 `smoke_test/ros_env.bats`，在 `docker build --target test` 时自动执行，共 **32** 项。
